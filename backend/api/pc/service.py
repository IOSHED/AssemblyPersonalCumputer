...
from api.pc.shemas import PCSchemaAdd, ComponentSchemaAdd, TypeComponentSchemaAdd
...
class TypeComponentService:
    @staticmethod
    async def add_component(uow: IUnitOfWork, type_component: TypeComponentSchemaAdd) -> int:
